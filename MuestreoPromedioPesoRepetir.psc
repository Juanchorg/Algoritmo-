Algoritmo MuestreoPromedioPesoRepetir
    Definir total_personas, contador, suma_peso_ninos, suma_peso_jovenes, suma_peso_adultos, suma_peso_viejos Como Real
    Definir promedio_peso_ninos, promedio_peso_jovenes, promedio_peso_adultos, promedio_peso_viejos Como Real
    ...
    Repetir
        ...
        contador <- contador + 1
    Hasta Que contador > total_personas
